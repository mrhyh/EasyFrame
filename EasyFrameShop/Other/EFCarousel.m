        ...
        case IGCarouselAnimationStyleFade:{
            ...
            [UIView animateWithDuration:0.2f animations:^{
                ...
                [UIView animateWithDuration:0.3f delay:0.0f options:2<<16 animations:^{
                    [carouselSubItem sd_setImageWithURL:[NSURL URLWithString:obj.imageURL] placeholderImage:Img(@"ic_loadingimg") options:0 completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                        if (image) {
...
-(void)reloadScrollData
{
    ...
    for (UIImageView *subItem in self.releasePool) {
        ...
        [subItem sd_setImageWithURL:[NSURL URLWithString:carouselObject.imageURL] placeholderImage:Img(@"ic_loadingimg") options:0 completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
            if (image) {
