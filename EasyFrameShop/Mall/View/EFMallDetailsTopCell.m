...
//    _countLabel.text = @"已售 275";
   ...
   NSString * _plistPath = [[NSBundle mainBundle] pathForResource:@"EasyFrame_" ofType:@"plist"];
    ...
    BOOL isClass = [[[NSDictionary alloc] initWithContentsOfFile:_plistPath][@"Mall"][@"isClass"] boolValue];
    if (isClass) {
...
//    [_button setTitle:@"50个评价" forState:0];
    UIImage * image = Img(@"Disclosure Indicator");
    ...
    [_button horizontalCenterTitleAndImageRight:80];
