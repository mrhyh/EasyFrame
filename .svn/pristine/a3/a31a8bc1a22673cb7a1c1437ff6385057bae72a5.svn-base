...
- (instancetype)init
{
    ...
    if (self) {
        ...
        NSMutableArray *btnImg = [NSMutableArray arrayWithObjects:@"ic_share_wx",@"ic_share_wxmoments",@"ic_share_weibo",@"ic_share_qq",@"ic_share_qzone",@"ic_share_more", nil];
        ...
        if (![WXApi isWXAppSupportApi] && ![WeiboSDK isCanShareInWeiboAPP]) {
            btnImg = [NSMutableArray arrayWithObjects:@"ic_share_qq",@"ic_share_qzone",@"ic_share_more", nil];
            btnName = [NSMutableArray arrayWithObjects:@"QQ",@"QQ空间",@"更多", nil];
        }else if (![WXApi isWXAppSupportApi]){
            btnImg = [NSMutableArray arrayWithObjects:@"ic_share_weibo",@"ic_share_qq",@"ic_share_qzone",@"ic_share_more", nil];
            btnName = [NSMutableArray arrayWithObjects:@"微博",@"QQ",@"QQ空间",@"更多", nil];
        }else if (![WeiboSDK isCanShareInWeiboAPP]) {
            btnImg = [NSMutableArray arrayWithObjects:@"ic_share_wx",@"ic_share_wxmoments",@"ic_share_qq",@"ic_share_qzone",@"ic_share_more", nil];
