...
//    [_button setTitle:@"50个评价" forState:0];
    ...
    [_button horizontalCenterTitleAndImageRight:95];
...
- (void)setProductDetail:(ProductDetailModel *)productDetail{
    ...
    NSAttributedString *attrStr =
    [[NSAttributedString alloc]initWithString:[NSString stringWithFormat:@"原价%zd",productDetail.marketPrice]
                                   attributes:
     @{NSFontAttributeName:[UIFont systemFontOfSize:13],
       NSForegroundColorAttributeName:cutColor,
       NSStrikethroughStyleAttributeName:@(NSUnderlineStyleSingle|NSUnderlinePatternSolid),
