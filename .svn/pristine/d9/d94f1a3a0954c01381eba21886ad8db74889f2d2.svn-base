...
- (void)showList{
    if (_m_view== nil) {
        ...
        _m_view = [[EFSelectView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-SCREEN_WIDTH/3, 0, SCREEN_WIDTH/3, 160) ObjectId:3 Array:nil andSelectBlock:^(CategoryModel *category) {
            _m_view.hidden = YES;
            _m_coverView.hidden = YES;
