...
typedef NS_ENUM(EFViewControllerCallBackAction, EFMailShopCart) {
    ...
    /****************商城-退货单信息管理rest接口**************/
    EFMailShopCart_ApplyReturnGood           = 1 <<20,// 申请退货
    EFMailShopCart_ReturnMyList           = 1 <<21,// 返回我的退货单
    EFMailShopCart_ApplyReturnMoney          = 1 <<21,// 申请退款
    EFMailShopCart_FindByOrder          = 1 <<22,// 根据订单id返回我的退货单
};
