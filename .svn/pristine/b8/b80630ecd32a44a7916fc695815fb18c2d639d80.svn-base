...
//    productPriceLabel.text = @"¥189";
    ...
    dismissButton.sd_layout.rightEqualToView(headerView).topEqualToView(headerView).widthIs(15).heightIs(15);
...
- (void)setProductDetailModel:(ProductDetailModel *)productDetailModel{
    ...
    [self.validProducts addObject:currentProductSpecification];
